...
- Is there a way to use Colab's GPUs while still maintaining the uv jupyterlab notebook setup in vs code?
  - Currently, I have to use my cheap laptop's resources which is just slow.
